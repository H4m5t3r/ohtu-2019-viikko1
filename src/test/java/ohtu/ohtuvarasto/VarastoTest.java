...
public class VarastoTest {
    ...
    public void setUp() {
        ...
        varasto3 = new Varasto(-15);
        varasto4 = new Varasto(-15, -3);
        varasto5 = new Varasto(-4, 18);
    }
